...
#ARClab
from arclab_crazyflie.msg import CMD_Flat
...
class crazyflie_class:
    def __init__(self, link_uri):
        ...
        #pub and sub objects
        self.sub_feeder = rospy.Subscriber("/mocap_node/crazyflie/pose", PoseStamped, self._send_mocap_pos)
